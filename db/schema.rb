...
ActiveRecord::Schema.define(version: 2020_10_15_084129) do
  ...
  create_table "article_features", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "article_id"
    t.bigint "feature_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_article_features_on_article_id"
    t.index ["feature_id"], name: "index_article_features_on_feature_id"
  end
  ...
  create_table "articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "public"
    t.bigint "feature_id"
    t.index ["feature_id"], name: "index_articles_on_feature_id"
  end
  ...
  create_table "owners", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["uid"], name: "index_owners_on_uid", unique: true
  end
  ...
  add_foreign_key "article_features", "articles"
  add_foreign_key "article_features", "features"
  add_foreign_key "article_tags", "articles"
  add_foreign_key "article_tags", "tags"
  add_foreign_key "articles", "features"
end
